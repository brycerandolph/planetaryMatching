...
void CGame::Message (CFrameWnd * windowP)
{
	...
	CString message = "CGame Over\nThanks for playing!\n" + CString(buffer);
	CString title = "CGame Over";
	windowP->KillTimer(1);
	windowP->MessageBox (message, title);
}
